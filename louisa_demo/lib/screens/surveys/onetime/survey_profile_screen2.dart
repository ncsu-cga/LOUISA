...
class _PaticipantInfoScreen2State extends State<PaticipantInfoScreen2> {
  final _formKeyPaticipantInfo = GlobalKey<FormState>();
          ...
          child: Padding(
            ...
            child: Form(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Container(
                  child: MaterialDatePicker('Birthday', _birthday,
                      Const.INITIAL_DATE, Const.MINIMUM_DATE),
                  // child: getDatePicker('Birthday', _birthday, Const.INITIAL_DATE, Const.MINIMUM_DATE),
                ),
                ...
                RoundedButton(
                  ...
                  onPressed: () {
                    ...
                    // }
                    if (_formKeyPaticipantInfo.currentState.validate()) {
                      // <-- this is recommended
                      _formKeyPaticipantInfo.currentState.save();
